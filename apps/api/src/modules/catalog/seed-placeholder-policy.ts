 ...
 *
 * Lives under apps/api/src so `tsc -p tsconfig.json` (rootDir: ./src) can typecheck
 * the unit spec. prisma/seed-placeholder-policy.ts re-exports this module; seed.ts
 * still imports `./seed-placeholder-policy`.
 */
