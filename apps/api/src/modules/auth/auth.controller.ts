...
export class AuthController {
  ...
  @ApiOperation({
    ...
    description:
      'Cria a conta e abre a mesma sessão do login (Set-Cookie sch_refresh e sch_access; JSON com usuário e access token). E-mail já cadastrado: 409 "Este e-mail já possui conta. Faça login." CPF já cadastrado: 409 "Este CPF já possui conta. Entre ou use outro CPF." CPF inválido ou menor de 18 anos: 400. Carrinho guest (header x-guest-token) é mesclado como no login.',
  })
