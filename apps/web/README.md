...
- Cadastro (`POST /auth/register`) abre a mesma sessão do login (`saveSession` + cookie `sch_refresh`). CPF ou e-mail já cadastrado volta 409 com a mensagem em português no campo. CPF inválido e menor de 18 continuam 400.
