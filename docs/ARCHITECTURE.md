...
5. Provedores (MP, Melhor Envio, **Firebase Cloud Messaging** para promo push no Android — `docs/PUSH-FCM.md`). Mercado Pago ativo; WhatsApp hoje é clique-para-conversar (`wa.me`, ver `docs/WHATSAPP.md`). Cloud API (Meta) é módulo futuro — sem tokens neste repo.
